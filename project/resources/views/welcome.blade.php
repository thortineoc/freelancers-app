...
<div class="flex justify-center pt-8  sm:pt-0">
    ...
    <div class="relative flex items-top justify-center mx-auto bg-gray-100 dark:bg-gray-900 sm:items-center sm:pt-0">
    @if (Route::has('login'))
            ...
            <div class="slideshow-container">
                <div class="mt-8 bg-white dark:bg-gray-800 overflow-hidden shadow sm:rounded-lg">
                    <div class="mySlides1 fade">
                        <img src="{{asset('images/obrazek1.jpeg')}}" style="width:100%">
                    </div>
                    <div class="mySlides1 fade">
                        <img src="{{asset('images/logo4.png')}}" style="width:100%">
                    </div>
            ...
            <div class="slideshow-container">
                <div class="mt-8 bg-white dark:bg-gray-800 overflow-hidden shadow sm:rounded-lg">
                    <div class="mySlides2 fade">
                        <img src="{{asset('images/obrazek3.jpeg')}}" style="width:100%">
                    </div>
                    <div class="mySlides2 fade">
                        <img src="{{asset('images/logo4.png')}}" style="width:100%">
                    </div>
                    ...
                    <div class="mySlides2 fade">
                        <img src="{{asset('images/obrazek2.jpeg')}}" style="width:100%">
                    </div>
                </div>
            </div>
